...
namespace Uniwear.Migrations
{
    ...
    [Migration("20260416063231_AddOutfitFields")]
    partial class AddOutfitFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uniwear.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Uniwear.Models.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Uniwear.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Uniwear.Models.WishlistItem", b =>
                {
                    ...
                    b.HasOne("Uniwear.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
